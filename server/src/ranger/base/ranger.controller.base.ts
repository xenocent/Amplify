...
export class RangerControllerBase {
  constructor(
  ...
  @swagger.ApiCreatedResponse({ type: Ranger })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Body() data: RangerCreateInput,
  ...
  @swagger.ApiOkResponse({ type: [Ranger] })
  @swagger.ApiForbiddenResponse()
  @ApiNestedQuery(RangerFindManyArgs)
  async findMany(
    @common.Req() request: Request,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<Ranger[]> {
    const args = plainToClass(RangerFindManyArgs, request.query);
  ...
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async findOne(
    @common.Param() params: RangerWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<Ranger | null> {
    const permission = this.rolesBuilder.permission({
      role: userRoles,
